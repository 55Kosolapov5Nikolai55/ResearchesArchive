...
import kosolapov.niko.TrainsinstanceofExample.Train;

import java.util.Objects;

public abstract class TraingetClass {
    private String route;
    private int wagons , wayLength , ID;

    public TraingetClass() {}

    public TraingetClass(String route, int wagons , int wayLength , int ID) {
        this.setRoute(route);
